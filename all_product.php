			        ...
			        <div id="sidebar"> 
			         ...
			         <div id="content_area"> 
                                  <div id="shopping_cart">
                                         <span style="float:right ;font-size:18px; line-length:40px; padding:10px; ">
                                             <b style="color:yellow;">Shopping_Cart-</b>Total Items:Total Price:<a href='cart.php' syle="color:yellow;">Go to Cart</a>
